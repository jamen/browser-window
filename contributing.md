# Contributing to browser-window

First and foremost, thank you! We appreciate that you want to contribute to browser-window, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for browser-window**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for browser-window:

- star the [project](https://github.com/jamen/browser-window)
- tweet your support for browser-window
...
- **version**: please note the version of browser-window are you using
...
[so]: http://stackoverflow.com/questions/tagged/browser-window